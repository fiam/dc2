...
| --- | --- | --- | --- |
| Instance | `RunInstances` | Partial | Launches container-backed instances, including `UserData` storage for IMDS. |
| Instance | `DescribeInstances` | Partial | Supports IDs and tag filters (`tag:*`, `tag-key`). |
